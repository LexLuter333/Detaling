...
export const reviewsAPI = {
  ...
  parse: (sourceIds = [], limit = 50) =>
    api.post('/admin/reviews/parse', { source_ids: sourceIds, limit }),
  getStats: () =>
    api.get('/admin/reviews/stats'),
};

// Review Sources API
export const reviewSourcesAPI = {
  getAll: () =>
    api.get('/admin/review-sources'),
  create: (source) =>
    api.post('/admin/review-sources', source),
  update: (id, source) =>
    api.put(`/admin/review-sources/${id}`, source),
  delete: (id) =>
    api.delete(`/admin/review-sources/${id}`),
};
